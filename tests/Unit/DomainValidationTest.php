...
class DomainValidationTest extends TestCase
{
    ...
    /** @test */
    public function validates_fqdn_with_many_subdomains()
    {
     ...
     */
    public function validates_domains_with_symbols()
    {
     ...
     */
    public function validates_digit_segments()
    {
    ...
    /** @test */
    public function validates_fqdn_with_root_zone()
    {
        $this->assertTrue($this->validate('mx.example.com.'));
    }

    /** @test */
    public function validates_internationalised_punycode_domains()
    {
