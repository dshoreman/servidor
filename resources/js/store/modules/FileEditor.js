...
export default {
    ...
    state: {
        ...
        cmModes: CodeMirror.modeInfo,
        cmSelectedMode: '',
    },
    mutations: {
        setTheme (state, theme) {
            state.cmOptions.theme = theme
        },
        setMode (state, mode) {
            state.cmOptions.mode = mode
        },
        setSelectedMode(state, name) {
            state.cmSelectedMode = name
        },
        setLineWrapping(state, value) {
            state.cmOptions.lineWrapping = value
        }
    },
    actions: {
    ...
    getters: {
        ...
        cmThemes: state => state.cmThemes,
        cmModes: state => state.cmModes,
        cmSelectedMode: state => state.cmSelectedMode,
    },
}
